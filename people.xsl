...
function showProduct(url)
{
	...
	document.getElementById("products_header").innerHTML="Loading Profile...";
}
function startup()
{
...
<li class="product type-product status-publish has-post-thumbnail product_cat-publications last instock shipping-taxable purchasable product-type-simple">
        ...
        <div class="product-description ">
                ...
                <ul class="cat-links"><li class="meta-category">
                             <a class="storecommerce-categories category-color-1" href="people.xml" alt="View all posts in Publications"> 
                                 People
                             </a>
                        </li></ul>            </span>
            <h4 class="product-title"><a href="people.xml?id={url}"><xsl:value-of select="title"/></a></h4>
