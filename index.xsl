...
<head>
	...
	<meta name="msapplication-TileImage" content="/favicon.png"/>
	    <title>Digital Worlds Institute Research Website, University of Florida</title>
...
<xsl:for-each select="data/categories/category">

 <div class="col-3 float-l pad btm-margi product-ful-wid" style="margin-bottom:10px;">
            <div class="sale-single-wrap">
                <div class="data-bg data-bg-hover sale-background" style="background-image: url(&quot;img/{image}&quot;);">
                    <a href="{url}"></a>
                </div>
                <div class="sale-info">
                    <span class="off-tb">
                        <span class="off-tc">
                          <span class="product-count"><span class="item-count"></span><span class="item-texts">browse</span></span>                    
                           <h4 class="sale-title"><xsl:value-of select="title"/></h4>
                        </span>
                    </span>
                </div>
            </div>
