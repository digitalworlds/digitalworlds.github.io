...
<head>
	...
	<meta name="msapplication-TileImage" content="/favicon.png"/>
	    <title>Publications - Digital Worlds Institute Research Website, University of Florida</title>
...
<li class="product type-product status-publish has-post-thumbnail product_cat-publications last instock shipping-taxable purchasable product-type-simple">
        ...
        <div class="product-description ">
                ...
                <ul class="cat-links"><li class="meta-category">
                             <a class="storecommerce-categories category-color-1" href="publications.xml" alt="View all posts in Publications"> 
                                 Publications
                             </a>
                        </li></ul>            </span>
            <h4 class="product-title"><a href="publications.xml?id={id}"><xsl:value-of select="title"/></a></h4>
