    ...
    <div id="content" class="site-content container-wrapper">
        ...
        <main id="main" class="site-main" role="main">
                ...
                <header id="products_header" class="woocommerce-products-header">
                    <h1 class="woocommerce-products-header__title page-title">Repositories</h1>    
                </header>
        <div class="columns-3"><ul id="products" class="products columns-3">


<xsl:for-each select="data/repositories/repository">
...
<li class="product type-product status-publish has-post-thumbnail product_cat-publications last instock shipping-taxable purchasable product-type-simple">
        ...
        <div class="product-description ">
                ...
                <ul class="cat-links"><li class="meta-category">
                             <a class="storecommerce-categories category-color-1" href="repositories.xml" alt="View all posts in Repositories"> 
                                 Repositories
                             </a>
                        </li></ul>            </span>
            <h4 class="product-title"><a href="{url}"><xsl:value-of select="title"/></a></h4>
